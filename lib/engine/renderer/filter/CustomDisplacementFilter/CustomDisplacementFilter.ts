 ...
 */
export class CustomDisplacementFilter extends Filter {
  ...
  constructor(sprite: ISpriteMaskTarget, scale?: number) {
    ...
    super(vertex, fragment, {
      ...
      rotation2: new Float32Array([1, 0, 0, 1]),
    })
  ...
  public apply(filterManager: FilterSystem, input: RenderTexture, output: RenderTexture, clearMode: CLEAR_MODES): void {
    ...
    //   ty: 0,
    // }
    // const lenX2 = Math.sqrt(wt2.a * wt2.a + wt2.b * wt2.b)
    // const lenY2 = Math.sqrt(wt2.c * wt2.c + wt2.d * wt2.d)
    //
    // if (lenX2 !== 0 && lenY2 !== 0) {
    //   this.uniforms.rotation[0] = wt2.a / lenX2
    //   this.uniforms.rotation[1] = wt2.b / lenX2
    //   this.uniforms.rotation[2] = wt2.c / lenY2
    //   this.uniforms.rotation[3] = wt2.d / lenY2
    // }
    ...
    this.uniforms.scale.x = this.scale.x * 3
    this.uniforms.scale.y = this.scale.y
    ...
    filterManager.applyFilter(this, target, output, clearMode)
